...
int main()
{
    ...
    const GLint TexLoc = glGetUniformLocation(program, "texSampler1");
    ...
    {
        { 0.5f, 0.5f, 0.5f,  0.6f, 0.6f, 0.6f,  0.3f, 0.3f, 0.3f,  30.0f },
        { 0.5f, 0.5f, 0.5f,  0.6f, 0.6f, 0.6f,  0.4f, 0.4f, 0.4f,  100.0f }
    };
